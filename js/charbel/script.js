let passwordField = document.querySelectorAll(".PasswordField");
    ...
    PrimaryPassword.onfocus = (()=>{
              if (PrimaryPassword.value.trim() == '') {
                    passwordFieldError.textContent = "Le champ du mot de passe est vide";
              ...
              setInterval(() => {
                if (PrimaryPassword.value.trim() == '') {
                  ...
                  passwordFieldError.textContent = "Votre mot de passe doit contenir une majuscule, une minuscule, un chiffre et un caractère spécial";
                  passwordFieldError.style.color="red";
                }
            ...
            SecondaryPassword.onfocus = (()=>{
              if (SecondaryPassword.value.trim() == '') {
                ConfirmpasswordFieldError.textContent = "Le champ de confirmation est vide";
              ...
              setInterval(() => {
                if (SecondaryPassword.value.trim() == '') {
                  ...
                  ConfirmpasswordFieldError.textContent = "Les mots de passe sont identiques";
                  ConfirmpasswordFieldError.style.color="green";
                }
                else{
                  ConfirmpasswordFieldError.textContent = "Les mots de passe doivent être les mêmes";
                  ConfirmpasswordFieldError.style.color="red";
                }
