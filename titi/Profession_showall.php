...
$contenu = $contenu."<thead style=\"background-color:#AAAAAA\" >  <th style=\"width:5%\">Numéro</th> <th style=\"width:5%\">id</th> <th style=\"width:5%\">Effacer</th> <th>Profession</th> </thead>\n";
  ...
  while($row = $result->fetch_assoc())
  {
    ...
    if(isset($_SESSION['current_user']))
    {
      ...
      if ($objAC->IsVisibleBy('./Activity_delete.php',$_SESSION['current_user']->group_name))
        $contenu = $contenu."<td><a href=\"/delete-Profession/".$row['id']."/\">Supprimer</a>";
      else
      	 $contenu = $contenu."<td>" ;
