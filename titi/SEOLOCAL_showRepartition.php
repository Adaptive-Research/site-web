...
$sql = "SELECT VilleMinu, count(*) as Nombre FROM Profession_Entreprises group by VilleMinu order by VilleMinu" ;
...
$contenu = $contenu."<thead style=\"background-color:#AAAAAA\" >  <th style=\"width:5%\">Numéro</th> <th>Ville</th> <th>Nombre</th> </thead>\n";
