...
$p1 = file_get_contents($baseREP.'/templates/Article_ShowInitial.html') ;
...
if ($result->num_rows > 0)
{
  ...
  //echo "<script>alert('".$URL_ArticleHTML."');</script>";


  $FichierPhrases = str_replace('.txt','-Phrases.txt',$FichierArticle) ;
  $Phrases = file_get_contents($FichierPhrases) ;
  $p1 = str_replace('[NETTOYE]',$Phrases,$p1) ;
