...
$contenu = $contenu."<thead style=\"background-color:#AAAAAA\" > <tr>  <th style=\"width:5%\">Numéro</th>  <th style=\"width:5%\">id</th> <th>URL Channel</th> <th>Article</th> </thead>\n";
...
$sql = "select r.Channel_URL, a.* from Articles as a, RSS as r  where a.iscurrent = 1 and a.HasBeenLoaded = 1 and (a.HasBeenCleaned is NULL or a.HasBeenCleaned = 0) and r.id = a.idRSS order by id asc " ;
