...
$contenu = $contenu."<thead style=\"background-color:#AAAAAA\" > <tr>   <th style=\"width:10%\">Prénom</th>  <th style=\"width:10%\">Nom</th>   <th style=\"width:10%\">Entreprise</th>  <th style=\"width:10%\">Date Event</th> </thead>\n";
...
$sql =  "select * from (select Prenom, Nom, Entreprise, max(DateEvent) as mde from Contacts_Rencontres as cr, Contacts as c where c.iscurrent = 1 and cr.idContacts = c.id group by Prenom, Nom, Entreprise) as temp order by mde  " ;
...
if ($result->num_rows > 0)
{
  ...
  while($row = $result->fetch_assoc())
  {
    ...
    $contenu = $contenu."<td>".ChangeDate($row['mde'])."</td>" ;
    $contenu = $contenu."</tr>\n" ;
