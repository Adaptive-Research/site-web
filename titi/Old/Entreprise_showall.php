...
$contenu = $contenu."<thead style=\"background-color:#AAAAAA\" > <tr>  <th style=\"width:5%\">Numéro</th>  <th style=\"width:5%\">id</th>  <th style=\"width:5%\">Effacer</th>  <th>Entreprise</th>  </thead>\n";
...
$sql = "select * from Entreprises where iscurrent = 1 collate utf8mb4_bin order by Entreprise asc " ;
...
if ($result->num_rows > 0)
{
  ...
  while($row = $result->fetch_assoc())
  {
    ...
    if ($objAC->IsVisibleBy('./Entreprise_delete.php',$_SESSION['current_user']->group_name))
      $contenu = $contenu."<td><a href=\"Entreprise_delete.php?id=".$row['id']."\"> <img src=\"./templates/img/b_drop.png\" title=\"Supprimer\" alt=\"Supprimer\"></a>";
    else
       $contenu = $contenu."<td>" ;
  ...
  $MyError = "<h3>pas d'entreprise à afficher</h3>";
