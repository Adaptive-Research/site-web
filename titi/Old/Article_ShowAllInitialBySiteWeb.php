...
$contenu = $contenu."<thead style=\"background-color:#AAAAAA\" > <tr>  <th style=\"width:5%\">Numéro</th> <th style=\"width:5%\">id</th> <th>Article</th> <th>Fichier</th> <th>Date</th> </thead>\n";
...
while($row2 = $result2->fetch_assoc())
{
  ...
  $contenu = $contenu.'<td><a href="./Article_ShowInitial.php?id='.$row2['id'].'">'.$row2['Article_Link'].'</a></td>' ;
