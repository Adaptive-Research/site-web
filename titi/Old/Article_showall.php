...
$sql = "select r.Channel_URL, a.* from Articles as a, RSS as r  where a.iscurrent = 1 and (a.HasBeenLoaded is NULL or a.HasBeenLoaded = 0) and r.id = a.idRSS order by id asc " ;
