...
$sql = "SELECT  * FROM Profession_Entreprises pe where pe.VilleMinu is not null and (pe.URL is null or pe.URL='') order by Titre " ;
if ($idVille != "")
  $sql = "SELECT  * FROM Profession_Entreprises pe where pe.VilleMinu =\"".$idVille."\" and (pe.URL is null or pe.URL='') order by Titre"  ;
