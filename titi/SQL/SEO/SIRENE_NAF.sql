...
--
-- Table structure for table `SIRENE_NAF`
--
...
--
-- Dumping data for table `SIRENE_NAF`
--

INSERT INTO `SIRENE_NAF` (`code`, `libelle`) VALUES
...
--
-- Indexes for table `SIRENE_NAF`
--
ALTER TABLE `SIRENE_NAF`
