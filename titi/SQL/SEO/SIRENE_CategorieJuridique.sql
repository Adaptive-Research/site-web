...
--
-- Host: localhost
-- Generation Time: Jul 02, 2022 at 03:08 PM
...
--
-- Table structure for table `SIRENE_CategorieJuridique`
--
...
CREATE TABLE `SIRENE_CategorieJuridique` (
  ...
  `libelle` varchar(150) COLLATE utf8mb4_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;

--
-- Dumping data for table `SIRENE_CategorieJuridique`
--

INSERT INTO `SIRENE_CategorieJuridique` (`code`, `libelle`) VALUES
...
--
-- Indexes for table `SIRENE_CategorieJuridique`
--
ALTER TABLE `SIRENE_CategorieJuridique`
