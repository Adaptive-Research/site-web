...
{
    global $ServeurWeb, $baseREP ,$baseURL  ;
...
Route::add($baseURL.'/Forgotten',function(){
    global $ServeurWeb, $baseREP,$baseLP,$baseURL ;
    require  $baseLP.'/Forgotten.php' ;
});
...
Route::add($baseURL.'/delete-User/([0-9]*)/',function($id){
    global $ServeurWeb, $baseREP ,$baseURL ;
    require $baseREP.'/user_delete.php' ;
});
